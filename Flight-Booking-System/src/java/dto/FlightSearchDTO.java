...
public class FlightSearchDTO {
    ...
    public String toString() {
        return "FlightSearchDTO{" + "flightId=" + flightId + ", economyPrice=" + economyPrice + ", businessPrice=" + businessPrice + ", airlineName=" + airlineName + ", airlineCode=" + airlineCode + ", departureAirportName=" + departureAirportName + ", departureAirportCode=" + departureAirportCode + ", arrivalAirportName=" + arrivalAirportName + ", arrivalAirportCode=" + arrivalAirportCode + ", departureAirportCity=" + departureAirportCity + ", arrivalAirportCity=" + arrivalAirportCity + ", flightNumber=" + flightNumber + ", departureTime=" + departureTime + ", arrivalTime=" + arrivalTime + ", seats=" + seats + '}';
    }
